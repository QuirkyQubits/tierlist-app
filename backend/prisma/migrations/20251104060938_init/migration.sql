/*
  ...
  - Added the required column `userId` to the `TierList` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "TierList" ADD COLUMN     "userId" INTEGER NOT NULL;
